...
public class AuthController {
    ...
    public ResponseEntity<String> login(@RequestBody final LoginUser loginUser) throws AuthenticationException {
        logger.info("Informations d'identification reçues : {}", loginUser.getEmail());
